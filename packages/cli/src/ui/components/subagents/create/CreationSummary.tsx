...
import type { SubagentManager } from '@qwen-code/qwen-code-core/subagents/subagent-manager.js';
import type { SubagentConfig } from '@qwen-code/qwen-code-core/subagents/types.js';
